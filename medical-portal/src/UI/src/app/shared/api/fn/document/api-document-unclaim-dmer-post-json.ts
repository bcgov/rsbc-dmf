...
export function apiDocumentUnclaimDmerPost$Json(http: HttpClient, rootUrl: string, params?: ApiDocumentUnclaimDmerPost$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<DmerDocument>> {
