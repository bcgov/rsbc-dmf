...
export function apiDocumentUnclaimDmerPost$Plain(http: HttpClient, rootUrl: string, params?: ApiDocumentUnclaimDmerPost$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<CaseDocument>> {
