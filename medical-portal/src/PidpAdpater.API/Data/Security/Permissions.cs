namespace pdipadapter.Data.Security;
...
public enum Permissions
{
    ...
    LeaseDelete = 22,
    [Display(GroupName = "referral", Name = "doctors-referral", Description = "Ability to Approve Medical Office Assitant Access Request")]
    DoctorsReferral = 23,
    [Display(GroupName = "driver", Name = "driver-view", Description = "Driver ability to view profile and their cases, documents")]
    Drivers = 24
