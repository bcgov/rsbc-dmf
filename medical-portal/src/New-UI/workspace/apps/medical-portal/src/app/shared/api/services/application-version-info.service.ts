...
export class ApplicationVersionInfoService extends BaseService {
   ...
   */
  static readonly ApiApplicationVersionInfoGetPath =
   ...
   */
  apiApplicationVersionInfoGet$Plain$Response(params?: {}): Observable<
    StrictHttpResponse<ApplicationVersionInfo>
  > {
    const rb = new RequestBuilder(
      this.rootUrl,
      ApplicationVersionInfoService.ApiApplicationVersionInfoGetPath,
      'get'
    );
    if (params) {
    }
   ...
   * This method doesn't expect any request body.
   */
  apiApplicationVersionInfoGet$Plain(params?: {}): Observable<ApplicationVersionInfo> {
    return this.apiApplicationVersionInfoGet$Plain$Response(params).pipe(
      map(
        (r: StrictHttpResponse<ApplicationVersionInfo>) =>
          r.body as ApplicationVersionInfo
      )
    );
  }
   ...
   * This method doesn't expect any request body.
   */
  apiApplicationVersionInfoGet$Json$Response(params?: {}): Observable<
    StrictHttpResponse<ApplicationVersionInfo>
  > {
    const rb = new RequestBuilder(
      this.rootUrl,
   ...
   * This method doesn't expect any request body.
   */
  apiApplicationVersionInfoGet$Json(params?: {}): Observable<ApplicationVersionInfo> {
