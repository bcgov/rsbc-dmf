...
export class ProfileService extends BaseService {
   ...
   */
  apiProfileCurrentGet$Plain$Response(params?: {}): Observable<
    StrictHttpResponse<UserProfile>
  > {
    const rb = new RequestBuilder(
      this.rootUrl,
      ProfileService.ApiProfileCurrentGetPath,
      'get'
    );
    if (params) {
    }
   ...
   * This method doesn't expect any request body.
   */
  apiProfileCurrentGet$Plain(params?: {}): Observable<UserProfile> {
   ...
   * This method doesn't expect any request body.
   */
  apiProfileCurrentGet$Json$Response(params?: {}): Observable<
    StrictHttpResponse<UserProfile>
  > {
    const rb = new RequestBuilder(
      this.rootUrl,
   ...
   * This method doesn't expect any request body.
   */
  apiProfileCurrentGet$Json(params?: {}): Observable<UserProfile> {
  ...
  apiProfileEmailPut$Response(params?: {
    ...
    const rb = new RequestBuilder(
      this.rootUrl,
      ProfileService.ApiProfileEmailPutPath,
      'put'
    );
    if (params) {
   ...
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  apiProfileEmailPut(params?: { body?: EmailUpdate }): Observable<void> {
   ...
   */
  static readonly ApiProfilePractitionerRolesGetPath =
    '/api/Profile/practitionerRoles';
   ...
   * This method doesn't expect any request body.
   */
  apiProfilePractitionerRolesGet$Response(params?: {}): Observable<
    StrictHttpResponse<void>
  > {
    const rb = new RequestBuilder(
      this.rootUrl,
      ProfileService.ApiProfilePractitionerRolesGetPath,
      'get'
    );
    if (params) {
    }
   ...
   * This method doesn't expect any request body.
   */
  apiProfilePractitionerRolesGet(params?: {}): Observable<void> {
   ...
   */
  static readonly ApiProfilePractitionerRolesPutPath =
    '/api/Profile/practitionerRoles';
  ...
  apiProfilePractitionerRolesPut$Response(params?: {
    ...
    const rb = new RequestBuilder(
      this.rootUrl,
      ProfileService.ApiProfilePractitionerRolesPutPath,
      'put'
    );
    if (params) {
      rb.body(params.body, 'application/*+json');
   ...
   */
  static readonly ApiProfilePractitionerRolesDeletePath =
    '/api/Profile/practitionerRoles';
  ...
  apiProfilePractitionerRolesDelete$Response(params?: {
    ...
    const rb = new RequestBuilder(
      this.rootUrl,
      ProfileService.ApiProfilePractitionerRolesDeletePath,
      'delete'
    );
    if (params) {
      rb.body(params.body, 'application/*+json');
