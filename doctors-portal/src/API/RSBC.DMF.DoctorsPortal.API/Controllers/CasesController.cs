...
namespace RSBC.DMF.DoctorsPortal.API.Controllers
{
    ...
    public class CasesController : ControllerBase
    {
        ...
        {
            new Case{ Id = "111", DriverLicense = "0200700", Status="Pending", PatientName = "patient 1", CreatedOn = DateTime.Parse("01/10/2021"), ModifiedOn = DateTime.Parse("01/10/2021"), ModifiedBy = "user1" },
            new Case{ Id = "222", DriverLicense = "0200700", Status="Completed", PatientName = "patient 2", CreatedOn = DateTime.Parse("01/20/2021"), ModifiedOn = DateTime.Parse("01/20/2021"), ModifiedBy = "user1" },
