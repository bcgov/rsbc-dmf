...
export function apiConfigGet$Plain(http: HttpClient, rootUrl: string, params?: ApiConfigGet$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<AppConfiguration>> {
