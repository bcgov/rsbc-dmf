...
export function apiProfileDriverPut$Plain(http: HttpClient, rootUrl: string, params?: ApiProfileDriverPut$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<OkResult2>> {
