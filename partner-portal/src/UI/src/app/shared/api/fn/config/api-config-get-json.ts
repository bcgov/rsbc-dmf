...
export function apiConfigGet$Json(http: HttpClient, rootUrl: string, params?: ApiConfigGet$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<AppConfiguration>> {
