...
import { apiCasesSearchIdCodeSurCodeGet$Json } from '../fn/cases/api-cases-search-id-code-sur-code-get-json';
import { ApiCasesSearchIdCodeSurCodeGet$Json$Params } from '../fn/cases/api-cases-search-id-code-sur-code-get-json';
import { apiCasesSearchIdCodeSurCodeGet$Plain } from '../fn/cases/api-cases-search-id-code-sur-code-get-plain';
import { ApiCasesSearchIdCodeSurCodeGet$Plain$Params } from '../fn/cases/api-cases-search-id-code-sur-code-get-plain';
...
export class CasesService extends BaseService {
  ...
  /** Path part for operation `apiCasesSearchIdCodeSurCodeGet()` */
  static readonly ApiCasesSearchIdCodeSurCodeGetPath = '/api/Cases/search/{idCode}/{surCode}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `apiCasesSearchIdCodeSurCodeGet$Plain()` instead.
   *
   * This method doesn't expect any request body.
   */
  apiCasesSearchIdCodeSurCodeGet$Plain$Response(params: ApiCasesSearchIdCodeSurCodeGet$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<CaseSearch>> {
    return apiCasesSearchIdCodeSurCodeGet$Plain(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `apiCasesSearchIdCodeSurCodeGet$Plain$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  apiCasesSearchIdCodeSurCodeGet$Plain(params: ApiCasesSearchIdCodeSurCodeGet$Plain$Params, context?: HttpContext): Observable<CaseSearch> {
    return this.apiCasesSearchIdCodeSurCodeGet$Plain$Response(params, context).pipe(
  ...
  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `apiCasesSearchIdCodeSurCodeGet$Json()` instead.
   *
   * This method doesn't expect any request body.
   */
  apiCasesSearchIdCodeSurCodeGet$Json$Response(params: ApiCasesSearchIdCodeSurCodeGet$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<CaseSearch>> {
    return apiCasesSearchIdCodeSurCodeGet$Json(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `apiCasesSearchIdCodeSurCodeGet$Json$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  apiCasesSearchIdCodeSurCodeGet$Json(params: ApiCasesSearchIdCodeSurCodeGet$Json$Params, context?: HttpContext): Observable<CaseSearch> {
    return this.apiCasesSearchIdCodeSurCodeGet$Json$Response(params, context).pipe(
      map((r: StrictHttpResponse<CaseSearch>): CaseSearch => r.body)
    );
  }
