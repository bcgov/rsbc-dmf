...
export class ConfigService extends BaseService {
   ...
   */
  apiConfigGet$Plain$Response(params?: ApiConfigGet$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<AppConfiguration>> {
   ...
   * This method doesn't expect any request body.
   */
  apiConfigGet$Plain(params?: ApiConfigGet$Plain$Params, context?: HttpContext): Observable<AppConfiguration> {
    return this.apiConfigGet$Plain$Response(params, context).pipe(
      map((r: StrictHttpResponse<AppConfiguration>): AppConfiguration => r.body)
    );
  }
   ...
   * This method doesn't expect any request body.
   */
  apiConfigGet$Json$Response(params?: ApiConfigGet$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<AppConfiguration>> {
   ...
   * This method doesn't expect any request body.
   */
  apiConfigGet$Json(params?: ApiConfigGet$Json$Params, context?: HttpContext): Observable<AppConfiguration> {
