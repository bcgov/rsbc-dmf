    ...
    */
    ...
    public class DriverTest : ApiIntegrationTestBase
    {
        ...
        public async void DfwebSubmitComment()
        {
            ...
            List<Rsbc.Dmf.BcMailAdapter.ViewModels.Case> cases = JsonConvert.DeserializeObject< List <Rsbc.Dmf.BcMailAdapter.ViewModels.Case>> (responseContent);
            ...
            var driver = new Rsbc.Dmf.BcMailAdapter.ViewModels.Driver() 
            { LicenseNumber = testDl, LastName = testSurcode};

            var comment = new Rsbc.Dmf.BcMailAdapter.ViewModels.Comment() 
            {  
            ...
            List<Rsbc.Dmf.BcMailAdapter.ViewModels.Comment> comments = JsonConvert.DeserializeObject<List<Rsbc.Dmf.BcMailAdapter.ViewModels.Comment>>(responseContent);
...
// ,"sequenceNumber":4,"commentTypeCode":"W","commentText":"test new one"}
    ...
    [Fact]
        ...
        public async void DfwebTestCommentType()
        {
            ...
            List<Rsbc.Dmf.BcMailAdapter.ViewModels.Comment> commentResults = JsonConvert.DeserializeObject<List<Rsbc.Dmf.BcMailAdapter.ViewModels.Comment>>(responseContent);
        ...
        */
        ...
        public async void DfcmsAddDocument()
        {
            ...
            var driver = new Rsbc.Dmf.BcMailAdapter.ViewModels.Driver() { LicenseNumber = testDl, LastName = testSurcode };

            string testString = "Test1234";
            // Convert a C# string to a byte array    
            byte[] bytes = Encoding.ASCII.GetBytes(testString);

            var comment = new Rsbc.Dmf.BcMailAdapter.ViewModels.Document()
            {
        ...
        public async void DfcmsAddRemoveDocument()
        {
            ...
            List<Rsbc.Dmf.BcMailAdapter.ViewModels.Document> documents = JsonConvert.DeserializeObject<List<Rsbc.Dmf.BcMailAdapter.ViewModels.Document>>(responseContent);
            ...
            documents = JsonConvert.DeserializeObject<List<Rsbc.Dmf.BcMailAdapter.ViewModels.Document>>(responseContent);
