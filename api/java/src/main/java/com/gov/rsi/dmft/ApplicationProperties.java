...
/**
 * A singleton holding configurable properties for the application. In this
 * implementation the properties are stored in the "application.properties" file
 * in the conventional "resources" folder in the project root. Future versions
 * could incorporate e.g. a database or url source.
 */
